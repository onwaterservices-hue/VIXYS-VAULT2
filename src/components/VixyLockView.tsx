    ...
    <div className="relative min-h-screen">
      ...
      <div className={`min-h-screen bg-[#0a0518] text-gray-200 font-mono text-xs pb-16 space-y-4 select-none transition-all duration-500 ${!hasActiveAccess ? 'filter blur-[14px] opacity-25 pointer-events-none select-none overflow-hidden h-[90vh]' : ''}`}>
        ...
        <div id="vixy-command-hero" className="grid grid-cols-1 lg:grid-cols-12 gap-4">
          ...
          <div className={`lg:col-span-7 vixy-card-elevated hud-corners p-5 sm:p-6 relative overflow-hidden flex flex-col justify-between transition-all duration-500 ${decisionAuraStyle}`}>
            ...
            <div>
              <div className="flex items-center justify-between border-b border-white/10 pb-3 mb-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-1.5 px-3 py-1 rounded-xl bg-gradient-to-r from-amber-500/25 via-amber-400/20 to-yellow-500/25 border-2 border-amber-400/80 shadow-[0_0_15px_rgba(251,191,36,0.5)]">
                    ...
                    <span className="text-sm font-black text-amber-300 drop-shadow-[0_0_10px_rgba(251,191,36,0.9)] hud-gradient-text" style={{ "--grad-a": "#fbbf24", "--grad-b": "#fdf8ff", "--grad-c": "#f59e0b", "--grad-glow": "rgba(251,191,36,0.9)" } as React.CSSProperties}>
              ...
              <div className="space-y-2.5 my-4">
                ...
                <div className="grid grid-cols-3 gap-2 text-center pt-1">
                  <div className={`hud-stat-card hud-corners py-2 px-2 transition-all duration-300 ${normalizedProbabilities.upPct >= 50 ? 'border-emerald-500/60 shadow-[0_0_15px_rgba(0,255,136,0.15)] ring-1 ring-emerald-500/30' : 'border-emerald-500/25'}`}>
                  ...
                  <div className={`hud-stat-card hud-corners py-2 px-2 transition-all duration-300 ${normalizedProbabilities.noTradePct >= 12 ? 'border-amber-500/60 shadow-[0_0_15px_rgba(245,158,11,0.15)]' : 'border-amber-500/25'}`}>
                  ...
                  <div className={`hud-stat-card hud-corners py-2 px-2 transition-all duration-300 ${normalizedProbabilities.downPct >= 50 ? 'border-rose-500/60 shadow-[0_0_15px_rgba(255,59,48,0.15)] ring-1 ring-rose-500/30' : 'border-rose-500/25'}`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 pt-3 border-t border-white/10 text-[10px]">
              <div className="hud-stat-card hud-corners p-2.5 border border-purple-900/30">
          ...
          <div className="lg:col-span-5 flex flex-col gap-4">
            ...
            <div className="vixy-card-elevated hud-corners p-5 shadow-[0_0_25px_rgba(157,78,221,0.15)] flex flex-col justify-between">
              <div>
                ...
                <div className="grid grid-cols-2 gap-2 text-[10px] mb-2.5">
                  <div className="hud-stat-card hud-corners p-2.5 border-2 border-amber-400/80 shadow-[0_0_20px_rgba(251,191,36,0.35)] relative overflow-hidden">
                    ...
                    <div className="text-xl sm:text-2xl font-black text-amber-300 font-mono hud-gradient-text" style={{ "--grad-a": "#fbbf24", "--grad-b": "#fdf8ff", "--grad-c": "#f59e0b", "--grad-glow": "rgba(251,191,36,0.9)" } as React.CSSProperties}>
                      {continuousInference.protectionDecision.lockScore} <span className="text-xs text-amber-200/70 font-normal">/ 100</span>
                    </div>
                  </div>
                  <div className="hud-stat-card hud-corners p-2.5 border border-purple-900/30 flex flex-col justify-between">
            ...
            <div className="vixy-card-elevated hud-corners p-5 shadow-[0_0_25px_rgba(6,182,212,0.1)] flex flex-col justify-between">
              ...
              <div className="text-[8.5px] text-gray-400 flex justify-between items-center mt-2 pt-2 border-t border-purple-900/30 font-mono">
                <span className="font-black hud-gradient-text text-[10px]" style={{ "--grad-a": "#06b6d4", "--grad-b": "#fdf8ff", "--grad-c": "#0ea5e9", "--grad-glow": "rgba(6,182,212,0.5)" } as React.CSSProperties}>CONFIDENCE: {continuousInference.gemini.confidence}%</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3">
            ...
            <div className="hud-stat-card hud-corners p-3.5 border border-emerald-500/30 flex flex-col justify-between">
              <div>
                ...
                <div className="text-lg font-black text-white hud-gradient-text" style={{ "--grad-a": "#34d399", "--grad-b": "#fdf8ff", "--grad-c": "#10b981", "--grad-glow": "rgba(52,211,153,0.4)" } as React.CSSProperties}>{spreadValueStr}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3">
            {indicatorAttributions.map((ind, idx) => {
              ...
              return (
                <div
                  key={ind.id || idx}
                  className={`hud-stat-card hud-corners p-3.5 border transition-all duration-300 flex flex-col justify-between ${
                    isWinner
        ...
        <div className="vixy-card-elevated hud-corners p-5 shadow-[0_0_25px_rgba(0,0,0,0.5)] space-y-4">
          <div className="flex flex-wrap items-center justify-between border-b border-purple-900/30 pb-3 gap-2">
            ...
            <div className="flex items-center space-x-2 text-xs">
              <span className="px-2.5 py-1 rounded-xl bg-[#00FF88]/20 border border-[#00FF88]/40 text-[#00FF88] font-black hud-gradient-text" style={{ "--grad-a": "#34d399", "--grad-b": "#fdf8ff", "--grad-c": "#10b981", "--grad-glow": "rgba(52,211,153,0.4)" } as React.CSSProperties}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 lg:grid-cols-10 gap-2">
              {recentSettlementRounds.map((round) => {
                ...
                return (
                  <div
                    key={round.id}
                    className={`p-2 hud-corners border text-center transition-all ${
                      isActive
