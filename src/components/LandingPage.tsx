...
import { PRICING, DAY_PASS_PRICE, STARTER_MONTHLY, THREE_DAY_PASSES_COST, PASS_VS_STARTER, usd } from '../config/pricing';
  ...
  const faqs = [
    {
      ...
      a: `The ${PRICING.dayPass.hours}-Hour Day Pass gives you exactly ${PRICING.dayPass.hours} hours of full, unrestricted VIXY Elite access for a ${DAY_PASS_PRICE} one-time payment. You get ${PRICING.dayPass.hours * 4} complete 15-minute prediction cycles, real-time orderbook depth, decision locks, and Discord signals. It does not auto-renew, so when the ${PRICING.dayPass.hours} hours are up the terminal locks again. If you want the engine running every day, three day passes cost ${THREE_DAY_PASSES_COST} and the Starter plan is ${STARTER_MONTHLY} for the full month.`,
    },
    {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            ...
            <div className="lg:col-span-5 p-6 rounded-2xl bg-[#0a0518]/95 border border-cyan-500/30 flex flex-col items-center sm:items-stretch gap-4 text-center sm:text-left">
              ...
              {/* Cost anchor. Pure arithmetic from the two prices already on this
                  page, generated from src/config/pricing.ts so it always matches
                  what Stripe charges. Nothing here is a projection, a discount or
                  a scarcity claim. */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-0.5">
                <span className="text-4xl font-black text-purple-300">
                  ${billingInterval === 'annual' ? PRICING.plans.STARTER.annualPerMonthUsd : PRICING.plans.STARTER.monthlyUsd}
                </span>
                <span className="text-xs text-purple-300/60 ml-1">/month</span>
                <p className="text-[10px] text-purple-300/50 block font-sans">
                  {billingInterval === 'annual' ? `Billed annually (${usd(PRICING.plans.STARTER.annualPerMonthUsd * 12)}/yr)` : 'Billed monthly'}
                </p>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-0.5">
                <span className="text-4xl font-black text-white">
                  ${billingInterval === 'annual' ? PRICING.plans.PRO.annualPerMonthUsd : PRICING.plans.PRO.monthlyUsd}
                </span>
                <span className="text-xs text-purple-300/60 ml-1">/month</span>
                <p className="text-[10px] text-purple-300/50 block font-sans">
                  {billingInterval === 'annual' ? `Billed annually (${usd(PRICING.plans.PRO.annualPerMonthUsd * 12)}/yr)` : 'Billed monthly'}
                </p>
              </div>
          ...
          <div className="bg-[#0a0518]/90 border border-purple-900/40 rounded-2xl p-6 space-y-6 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <div className="space-y-0.5">
                <span className="text-4xl font-black text-purple-300">
                  ${billingInterval === 'annual' ? PRICING.plans.ELITE.annualPerMonthUsd : PRICING.plans.ELITE.monthlyUsd}
                </span>
                <span className="text-xs text-purple-300/60 ml-1">/month</span>
                <p className="text-[10px] text-purple-300/50 block font-sans">
                  {billingInterval === 'annual' ? `Billed annually (${usd(PRICING.plans.ELITE.annualPerMonthUsd * 12)}/yr)` : 'Billed monthly'}
                </p>
              </div>
