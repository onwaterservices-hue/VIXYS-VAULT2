...
// Update the returned decision to dynamically recalculate timeRemainingSec
content = content.replace(
  `  return {\n    decision,\n    isLoading,`,
...
console.log("Patched src/hooks/useCanonical15mDecision.ts successfully");
