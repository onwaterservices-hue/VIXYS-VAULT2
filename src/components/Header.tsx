            ...
            <a
              ...
              className={`px-3 py-1.5 rounded-xl flex items-center gap-1.5 transition-all cursor-pointer ${
                hasActiveAccess
                  ...
                  : 'bg-[#0c0620] border border-purple-800/60 text-purple-300 hover:text-white hover:border-purple-500'
              }`}
            >
            ...
            {isLoading ? (
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-[#0a0518] border border-purple-900/40 text-xs text-purple-200 font-bold hover:border-purple-500/50 hover:text-white transition-all max-w-[160px] sm:max-w-[220px]"
                >
                ...
                <button
                  onClick={onLogout}
                  title="Sign Out"
                  className="p-2 rounded-xl bg-[#0a0518] border border-purple-900/40 text-purple-400 hover:text-rose-400 hover:border-rose-500/30 transition-all shrink-0"
                >
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div className="hidden xl:flex items-center gap-2 text-[11px] font-mono text-purple-200 bg-[#0c0620] px-3.5 py-1.5 rounded-xl border-2 border-purple-500/40 shadow-lg shadow-purple-950/60">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-[#0a0518] border border-purple-700/60 text-xs font-bold text-purple-200 hover:text-white hover:border-purple-400 transition-all font-mono cursor-pointer"
                >
                  Log In
                </button>
                ...
                >
                  ...
                  <div className="relative flex items-center gap-2 px-4 py-2 rounded-[10px] bg-[#0a0518] text-xs font-mono font-bold transition-colors group-hover:bg-[#0c0620]">
                    <span className="w-2 h-2 rounded-full bg-cyan-300 animate-ping" />
                    <span className="text-white tracking-wider font-black text-[11px] sm:text-xs drop-shadow">
                      VIXY VAULT ACCESS
                    </span>
                    <span className="px-2.5 py-1 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-slate-950 text-[11px] font-black tracking-tight shadow-md">
                      24H PASS • $9.99
                    </span>
                  </div>
                </button>
    ...
    <header className="sticky top-0 z-40 bg-[#06030d]/95 backdrop-blur-xl border-b border-purple-500/30 shadow-[0_4px_25px_rgba(147,51,234,0.15)] text-purple-100">
      ...
      <div className="bg-[#0a0518]/90 px-3 sm:px-4 py-1 text-xs border-b border-purple-900/40 flex flex-wrap items-center justify-between gap-2 font-mono">
        <div className="flex items-center gap-2 overflow-x-auto py-0.5 scrollbar-none">
          ...
          {(() => {
            ...
            return (
              <div className="flex items-center gap-1.5 font-bold text-purple-200 bg-[#0c0620] px-2.5 py-0.5 rounded-xl border border-purple-800/50 shadow-sm shrink-0">
          ...
          <div className="flex items-center gap-1.5 px-2.5 py-0.5 rounded-xl bg-[#0c0620] border border-purple-800/50 text-[10.5px] text-purple-200 shrink-0">
          ...
          <div className="hidden md:flex items-center gap-2 px-2.5 py-0.5 rounded-xl bg-[#0c0620] border border-purple-800/50 text-[10px] font-mono shrink-0">
        ...
        <div className="flex items-center gap-2 text-[11px] shrink-0">
          {/* Timezone Indicator */}
          <div
            className="flex items-center gap-1 px-2 py-0.5 rounded-xl bg-[#0c0620] border border-purple-800/50 text-purple-300 font-mono text-[10px]"
          ...
          {dayPassInfo?.active && dayPassInfo.expiresAt ? (
            <div
              ...
              className="flex items-center gap-1.5 px-2.5 py-0.5 rounded-xl bg-gradient-to-r from-amber-950/80 to-purple-950/80 border border-amber-500/40 text-[10.5px] font-mono shadow-sm cursor-pointer hover:border-amber-400 transition-all"
          ...
          {/* Subtle Role Badge */}
          <div className="flex items-center gap-1 bg-[#0a0518] px-2 py-0.5 rounded-xl border border-purple-800/50 text-[10px] font-mono text-purple-300">
      ...
      <div className="w-full max-w-[1700px] mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-3 font-mono">
        ...
        <nav className="hidden lg:flex items-center gap-1 bg-[#0c0620] p-1 rounded-2xl border border-purple-800/40 shadow-inner shadow-purple-950/50">
          ...
          {/* Asset Compare */}
          <a
            href={TAB_TO_PATH['compare']}
            onClick={(e) => { e.preventDefault(); setActiveTab('compare'); }}
          ...
          <a
            href={TAB_TO_PATH['scalping']}
            onClick={(e) => { e.preventDefault(); setActiveTab('scalping'); }}
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold transition-all duration-200 cursor-pointer ${
              activeTab === 'scalping'
          ...
          <a
            href={TAB_TO_PATH['onehour']}
            onClick={(e) => { e.preventDefault(); setActiveTab('onehour'); }}
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold transition-all duration-200 cursor-pointer ${
              activeTab === 'onehour'
                ? 'bg-gradient-to-r from-purple-600 to-indigo-600 text-white shadow-lg shadow-purple-600/40 border border-purple-400/30'
                : 'text-purple-200/90 hover:text-white hover:bg-purple-900/40'
          ...
          {isLoading ? (
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() => setActiveTab(userRole === 'ADMIN' ? 'admin' : 'settings')}
                title={userRole === 'ADMIN' ? 'Master Admin Control Center' : 'User Settings'}
                className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-[#0a0518] border border-purple-900/40 text-xs text-purple-200 font-bold hover:border-purple-500/50 hover:text-white transition-all max-w-[160px] sm:max-w-[220px]"
              >
                <User className="w-3.5 h-3.5 text-purple-400 shrink-0" />
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() => onOpenAuth('login')}
                className="px-3.5 py-2 rounded-xl bg-[#0a0518] border border-purple-900/40 text-xs font-bold text-purple-200 hover:text-white hover:border-purple-500/50 transition-all"
              >
                Log In
              </button>
              <button
      ...
      {/* Mobile Bar */}
      <div className="lg:hidden flex items-center justify-around bg-[#0c0620] border-t border-purple-900/30 px-2 py-2 overflow-x-auto text-[11px] font-mono">
        <button
          onClick={handleNavigateVixyLive}
          className={`flex flex-col items-center gap-1 px-2.5 py-1 rounded-xl cursor-pointer ${activeTab === 'vixylive' ? 'bg-gradient-to-r from-amber-500 to-purple-600 text-slate-950 font-black' : 'text-amber-300 font-bold'}`}
        >
